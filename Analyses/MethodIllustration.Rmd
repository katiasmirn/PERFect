...
author: "Ekaterina Smirnova and Quy Cao"
date: "`r date()`"
output:
...
set.seed(12341)
#setwd("C:/Users/Quy/Dropbox/Quy/PERFect/PERFect-master/R")#change me
setwd("~/Dropbox/PERFect/RCode/")

```

The PERFect software is freely available at https://github.com/katiasmirn/PERFect
...
The simultaneous PERFect algorithm yields preliminary taxa significance. Taxa can also be ordered by abundance and this step is not necessary; however method evation on mock data has shown that ordering taxa by  simultaneous PERFect p-values improves permutation PERFect performance.
...
The OTU table above indicates that the first significantly small averaged p-value is $p_{14}= 0.02 \leq 0.1 :=\alpha$, which occurs at the first signal taxon $S_6$. Thus the algorithm has succesfully filtered noise taxa and preserved all the true signal taxa.  
